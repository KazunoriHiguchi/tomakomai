  ...
  return (
    <div className="bg-gray-100 pt-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 px-12 py-8">
        <SupportCell img={Medical} type={"医療"} />
        <SupportCell img={Raising} type={"出産・子育て"} />
        <SupportCell img={Education} type={"教育"} />
        <SupportCell img={Emergency} type={"緊急"} />
        <SupportCell img={Job} type={"就労"} />
        <SupportCell img={Transportation} type={"交通"} />
        <SupportCell img={Tax} type={"税金"} />
        <SupportCell img={DailyLife} type={"日常生活"} />
      </div>
    </div>
  );
}
